...
// Uppdatera metadata med metadataBase och flytta viewport och themeColor till egna exports
export const metadata: Metadata = {
  ...
  robots: "index, follow",
  metadataBase: new URL("https://pixai-search.netlify.app"), // Lägg till metadataBase här
  openGraph: {
    type: "website",
...
// Flytta viewport och themeColor till egna exports
...
export default function RootLayout({
  ...
  return (
    <html lang="sv" suppressHydrationWarning>
      <body
        className={`${geistSans.variable} ${geistMono.variable} font-sans min-h-screen relative`}
      >
        <ThemeProvider
          attribute="class"
          defaultTheme="system"
